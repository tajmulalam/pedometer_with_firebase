...
import com.stepproject.app.adapters.TopUsersListAdapter;
import com.stepproject.app.managers.DashboardManager;
...
import com.stepproject.app.models.UserToUserRelation;
import com.stepproject.app.pedometer.Pedometer;
import com.stepproject.app.pedometer.SettingsActivity;
import com.stepproject.app.pedometer.Trace;
import com.stepproject.app.utils.ConnectionChecker;
...
//        dashboardManager.getTopUser(SharedPreferenceValue.getLoggedinUser(activity));
    ...
    /// 1= friend list, 2= search friend list
    ...
    /// called when login user not found in firebase
    @Override
    public void noUserFound() {

    }

    /// called when refresh button clicked and update current day score to firebase database
    @Override
